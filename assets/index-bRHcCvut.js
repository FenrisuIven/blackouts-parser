...
`).forEach(r=>{i.push(r)})}function E(){if(document.querySelector("#create-table"))return;const e=document.createElement("button");e.textContent="Create Table",e.addEventListener("click",()=>{d()}),e.id="create-table",document.querySelector("#app").appendChild(e)}async function C(){}const a=`■ 00:00-01:00  2, 3 та 4 черги
