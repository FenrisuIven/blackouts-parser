...
`).forEach(r=>{i.push(r)})}function b(){if(document.querySelector("#create-table"))return;const e=document.createElement("button");e.textContent="Create Table",e.addEventListener("click",()=>{a()}),e.id="create-table",document.querySelector("#app").appendChild(e)}async function x(){}const d=`■ 00:00-01:00  1, 3 та 6 черги
